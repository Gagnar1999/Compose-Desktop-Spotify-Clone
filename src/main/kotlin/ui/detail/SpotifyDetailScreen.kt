    ...
    Row(
        ...
        modifier = Modifier
            ...
            .horizontalGradientBackground(
                if (Dp(scrollState.value.toFloat()) < 700.dp)
        ...
        Icon(imageVector = Icons.Default.MoreVert, tint = MaterialTheme.colors.onSurface, contentDescription = "")
    }
}
...
fun TopAlbumInfoOverlay(scrollState: ScrollState) {
    ...
    Box(
        modifier = Modifier.fillMaxWidth()
            .height(380.dp)
            .background(MaterialTheme.colors.surface.copy(alpha = animateFloatAsState(dynamicAlpha).value))
    )
}
...
fun PlayButtons() {
    Row(modifier = Modifier.padding(16.dp)) {
        ...
        Icon(imageVector = Icons.Default.Favorite, tint = spotifyGreen, modifier = Modifier.padding(16.dp), contentDescription = "")
        Icon(
...
fun TopAlbumInfoSection(album: Album, scrollState: ScrollState) {
    Row(modifier = Modifier.padding(top = 100.dp, start = 16.dp), verticalAlignment = Alignment.CenterVertically) {
        ...
        val animateImageSize = animateDpAsState(dynamicValue)
        Image(
            painterResource(album.imageId),
            modifier = Modifier
                .size(animateImageSize.value)
                .padding(8.dp),
            contentDescription = ""
        )
        Column {
